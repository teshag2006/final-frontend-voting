        ...
        <div className="flex items-center gap-3">
          {socialLinks.map((social) => (
            <a
              key={social.label}
              href={social.href}
              className="flex h-8 w-8 items-center justify-center rounded-full bg-secondary text-muted-foreground transition-colors hover:bg-foreground hover:text-card"
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-4 py-4 lg:px-8">
          <p className="text-center text-xs text-muted-foreground sm:text-right">
            &copy; 2026 Miss {"&"} Mr Africa Global. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
