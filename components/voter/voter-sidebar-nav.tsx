...
import { CreditCard, LayoutDashboard, Moon, Settings, Sun, Vote } from 'lucide-react';
...
export function VoterSidebarNav() {
  ...
  return (
    <>
      <aside
        className={cn(
          'hidden h-full w-64 flex-col overflow-hidden pt-4 lg:flex',
          theme === 'topbar-dark'
      ...
      <div className="lg:hidden">
        <nav
          className={cn(
            'flex gap-2 overflow-x-auto rounded-xl p-2 shadow-sm',
            theme === 'topbar-dark'
              ? 'border border-blue-950 bg-gradient-to-r from-slate-900 to-blue-900'
