...
const DEFAULT_SPONSOR_SETTINGS: SponsorProfileSettings = {
  general: {
    companyName: '',
    logoUrl: '',
    description: '',
...
const DEFAULT_SPONSOR_OVERVIEW: SponsorDashboardOverview = {
  sponsorName: 'Sponsor',
  trustScore: 0,
...
let campaignTrackingStore: SponsorCampaignTracking[] = [];
let settingsStore: SponsorProfileSettings = structuredClone(DEFAULT_SPONSOR_SETTINGS);
